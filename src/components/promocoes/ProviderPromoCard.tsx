 ...
 * Desktop: arte completa (sem crop), alinhada ao grid da página.
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Desktop: arte 5:1 inteira — sem crop / sem overflow que corte cantos */}
          <div className="relative hidden md:block">
            {!imageFailed ? (
              <Image
                ...
                priority
                className={cn(
                  /* sem border-radius: cantos arredondados cortavam VOCÊ ESCOLHE / furadeira */
                  ...
                  'group-hover:shadow-[0_4px_20px_rgba(24,95,165,0.08)] group-hover:ring-brand-blue-border',
                )}
                sizes={
                  isHome
          ...
          <div className="overflow-hidden rounded-xl border border-cp-border/80 bg-white md:hidden">
            {!imageFailed ? (
